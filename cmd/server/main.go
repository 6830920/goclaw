...
<body>
    ...
    <div class="modal" id="dev-status-modal">
        <div class="modal-content">
            ...
            <div id="dev-status-content">
                ...
                <div class="status-section">
                    <div class="status-label">最近修改文件</div>
                    <ul class="status-list">
    ...
    <script>
        ...
        function updateDevStatusDisplay(data) {
            ...
            // Update commit info
            document.getElementById('commit-hash').textContent = data.lastCommit.hash || '未知';
            document.getElementById('commit-message').textContent = data.lastCommit.message || '未知';
            document.getElementById('commit-author').textContent = data.lastCommit.author || '未知';
            document.getElementById('commit-date').textContent = data.lastCommit.date || '未知';
            document.getElementById('commit-time-ago').textContent = data.lastCommit.timeAgo || '未知';
            document.getElementById('commit-branch').textContent = data.lastCommit.branch || '未知';
            
            // Update file modification info
            document.getElementById('file-name').textContent = data.lastFileMod.filename || '未知';
            document.getElementById('file-path').textContent = data.lastFileMod.path || '未知';
            document.getElementById('file-time').textContent = data.lastFileMod.modifiedTime || '未知';
            document.getElementById('file-time-ago').textContent = data.lastFileMod.timeAgo || '未知';
